...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("www.diti5.springboot1.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("www.diti5.springboot1.security.DomainUserDetailsService", "createSpringSecurityUser");
